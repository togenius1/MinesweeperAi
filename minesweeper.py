...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        new_sentence = Sentence(unknown_neighbors, count - len(known_mines))
            ...
            for sentence1 in self.knowledge:
                for sentence2 in self.knowledge:
                    if sentence1 != sentence2 and sentence1.cells.issubset(sentence2.cells):
                        ...
                        if new_inference not in self.knowledge and new_inference not in new_inferences and len(new_inference.cells) > 0:
